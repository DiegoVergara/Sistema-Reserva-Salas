...
Class mod_reportes2 extends CI_Model
{
...
public function total_reservas_salon_dia($fecha)  // reservas sin eliminar // //PDF
    {
     $q_string = "select salon, count(salon) as cant from reservas_2 where fecha ='".$fecha."' and eliminada ='0' and estado ='1' group by salon";
...
//Todas las reservas del dia
 ...
 public function obtener_reservas_diarias($fecha) //EXCELL
    {
      $this->db->select('salon,hora_entrada,hora_salida,salida,nombre,cant_personas,id_e');
...
public function total_reservas_salon_semana($fecha)  // reservas sin eliminar // /PDF
    {
     $q_string = "select salon, count(salon) as con from reservas_2 where week(fecha) =week('".$fecha."') and eliminada ='0' and estado ='1' group by salon";
	 	 $data = $this->db->query($q_string);
 ...
 public function obtener_reservas_semanales($fecha) //EXCELL
    {
    	 ...
    	 $q_string = "select fecha, salon, hora_entrada, hora_salida, nombre, salida, cant_personas from reservas_2 where week(fecha) = week('".$fecha."') and eliminada ='0' and estado ='1'";
	 	 $data = $this->db->query($q_string);
...
public function total_reservas_salon_mes($fecha)  // reservas sin eliminar // //PDF
    {

     $q_string = "select salon, count(salon) as cant from reservas_2 where month(fecha) = month('".$fecha."') and eliminada ='0' and estado ='1' group by salon";
 ...
 public function obtener_reservas_mensuales($fecha) //EXCELL
    {
     ...
     $q_string = "select fecha, salon, hora_entrada, hora_salida, nombre, salida, cant_personas from reservas_2 where month(fecha) = month('".$fecha."') and eliminada ='0' and estado ='1' group by fecha";
...
*/
    ...
    {
    	$q_string = "select fecha, salon, hora_entrada, hora_salida, nombre, id_e, cant_personas, observacion from reservas_2 where fecha between '".$finicio."' and '".$ffin."' and eliminada > '0'  and estado ='1' order by fecha";
	...
	// observaciones
	    ...
	    public function observaciones_confirmadas($finicio, $ffin) // EXCELL
    {
    	$q_string = "select fecha, salon, hora_entrada, hora_salida, salida, nombre, id_e, cant_personas, observacion from reservas_2 where fecha between '".$finicio."' and '".$ffin."' and eliminada = '0' and salida is not null and estado = '1' order by fecha";
		//select fecha, sala, modulo, id_a, nombre_a, carrera_a, observacion
		//from reservas
	    ...
	    public function observaciones_generales($finicio, $ffin) // EXCELL
    {
    	$q_string = "select fecha, salon, hora_entrada, hora_salida, nombre, id_e, cant_personas, observacion from reservas_2 where fecha between '".$finicio."' and '".$ffin."' and eliminada = '0' and salida is null and estado = '1' order by fecha";
		//select fecha, sala, modulo, id_a, nombre_a, carrera_a, observacion
		//from reservas
		//where fecha between '2014/06/05' and '2014/06/30' and eliminada > '1' and confirmada = '0'
		//order by fecha
    ...
    {
    	$q_string = "select salon, count(salon) as con from reservas_2 where fecha between '".$finicio."' and '".$ffin."' and eliminada = '0' and estado ='1' group by salon order by salon";
		//select sala, count(sala) as con
		//from reservas
		//where fecha between '2014/06/05' and '2014/06/30' and eliminada = '0' and estado ='1'
		//group by sala
    ...
    {
    	$q_string = "select fecha, id_e, count(id_a) as con from reservas_2 where fecha between '".$finicio."' and '".$ffin."' and eliminada = '0' and estado ='1' group by fecha order by fecha";
