...
// REPORTE POR CARRERA en un intervalo de fecha
    ...
    {
    	$q_string = "select carrera_a, count(id_a) as con from reservas where fecha between '".$finicio."' and '".$ffin."' and eliminada = '1' and confirmada = '0' and estado ='1' group by carrera_a";
    ...
    {
    	$q_string = "select fecha, sala, modulo, id_a, nombre_a, carrera_a, id_e, cant_alumnos, observacion from reservas where fecha between '".$finicio."' and '".$ffin."' and eliminada > '1' and confirmada = '0' and estado ='1' order by fecha";
	...
	// observaciones
	    ...
	    public function observaciones_inasistencia($finicio, $ffin) // EXCELL
    {
    	$q_string = "select fecha, sala, modulo, id_a, nombre_a, carrera_a, id_e, cant_alumnos, observacion from reservas where fecha between '".$finicio."' and '".$ffin."' and eliminada = '1' and confirmada = '0' and estado = '1' order by fecha";
		//select fecha, sala, modulo, id_a, nombre_a, carrera_a, observacion
		//from reservas
    ...
    {
    	$q_string = "select fecha, sala, modulo, id_a, nombre_a, carrera_a, id_e, cant_alumnos, salida, observacion from reservas where fecha between '".$finicio."' and '".$ffin."' and eliminada = '0' and confirmada = '1' and estado = '1' order by fecha";
		//select fecha, sala, modulo, id_a, nombre_a, carrera_a, observacion
		//from reservas
		//where fecha between '2014/06/05' and '2014/06/30' and eliminada > '1' and confirmada = '0'
		//order by fecha
    ...
    {
    	$q_string = "select fecha, sala, modulo, id_a, nombre_a, carrera_a, id_e, cant_alumnos, observacion from reservas where fecha between '".$finicio."' and '".$ffin."' and eliminada = '0' and confirmada = '0' and estado = '1' order by fecha";
		//select fecha, sala, modulo, id_a, nombre_a, carrera_a, observacion
		//from reservas
		//where fecha between '2014/06/05' and '2014/06/30' and eliminada > '1' and confirmada = '0'
		//order by fecha
