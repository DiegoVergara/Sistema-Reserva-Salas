...
<body data-url="<?php echo base_url();?>">
  <section id="container">
    ...
    <aside>
      <div id="sidebar">
        <ul id="menu_reportes" class="nav nav-pills nav-stacked">
          ...
          <li class="active"><a href="#" data-action="index.php/reportes2/ReporteDiario" data-interval="1"><span class="fa fa-clock-o"></span> Diario</a></li>
          <li><a href="#" data-action="index.php/reportes2/ReporteSemanal" data-interval="1"><span class="fa fa-calendar-o"></span> Semanal</a></li>
          <li><a href="#" data-action="index.php/reportes2/ReporteMensual" data-interval="1"><span class="fa fa-calendar"></span> Mensual</a></li>
          <li><a href="#" data-action="index.php/reportes2/ReporteOcupacion" data-interval="2"><span class="fa fa-users"></span> Ocupación</a></li>
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes2/ReporteObservaciones_toExcel');?>"><span class="fa fa fa-book"></span> Reservas - Concluidas </a></li>
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes2/ReporteObservacionesE_toExcel');?>"><span class="fa fa fa-book"></span> Reservas - Eliminación </a></li>
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes2/ReporteObservacionesG_toExcel');?>"><span class="fa fa fa-book"></span> Reservas - General </a></li>
        </ul> <!-- imputs de texto-->
    ...
    <section id="main-content">
      ...
      <form id="form_excel" action="" method="POST">
        <input id="fecha_excel" name="fecha_excel" type="hidden">
        <input id="fecha_excel_fin" name="fecha_excel_fin" type="hidden">
        <a id="to_xls" style="display: none;" class="btn btn-success" href="#"><span class="fa fa-file-excel-o"> Exportar a Excel</span>
        </a>
      </form>
  ...
  <script>
              ...
              if(data.series.length==0){
                alert('No se encontraron datos');
                  ...
                  window.chart = new Highcharts.Chart({  // muestra el pluging
                    ...
                    $('#form_excel').attr('action',data.xls_path); // ruta en controlador a excel
                    $('#fecha_excel').val($('#fecha_inicio').find("input").val());
                    $('#fecha_excel_fin').val($('#fecha_fin').find("input").val());
              }
            }
          });
        }
        else{
          $('#form_excel').attr('action',xls_path); // ruta en controlador a excel
          $('#fecha_excel').val($('#fecha_inicio').find("input").val());
          $('#fecha_excel_fin').val($('#fecha_fin').find("input").val());
          $('#form_excel').submit();
        }
    ...
    $(document).on('click','#to_xls',function(e){
      e.preventDefault();
      e.stopPropagation();
      $('#form_excel').submit();
    });
