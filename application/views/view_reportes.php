        ...
        <!-- ########## -->    
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="<?php echo site_url('reportes2');?>"><span class="fa fa-institution"></span> Salones</a></li> <!-- CAMBIAR-->
              </ul>
            </li>
        <!-- ########## -->
            <li class="dropdown">
    ...
    <aside>
      <div id="sidebar">
        <ul id="menu_reportes" class="nav nav-pills nav-stacked">
          ...
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes/ReporteObservaciones_toExcel');?>"><span class="fa fa-book"></span> Reservas - Confirmadas </a></li>
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes/ReporteObservacionesE_toExcel');?>"><span class="fa fa-book"></span> Reservas - Eliminación </a></li>
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes/ReporteObservacionesI_toExcel');?>"><span class="fa fa-book"></span> Reservas - Inasistencias </a></li> 
          <li><a href="#" data-action="" data-interval="2" data-xls-path="<?php echo site_url('reportes/ReporteObservacionesG_toExcel');?>"><span class="fa fa-book"></span> Reservas - General </a></li>
