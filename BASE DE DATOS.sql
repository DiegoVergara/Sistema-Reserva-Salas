...
create table reservas_2(
	...
	id_e varchar(40) not null,
	observacion varchar (256),
	constraint reservas_2_pk primary key (fecha, salon, hora_entrada, eliminada, hora_salida)
);
...
INSERT INTO alumnos VALUES('4','Felipe Santiago','Jorquera Uribe',22,'Ing. Civil Inf',2011,3456789,'fjorquera@mail.cl');INSERT INTO `alumnos` VALUES('21','Carolina Francisca','Morales Ramirez',22,'Enfermeria',2011,7777777,'cmorales@mail.cl');
